      ...
      <Container>
        <CardInfo>
          <Header>
            ...
            {i !== 0 && <Cancel type="button" onClick={() => removeCard(i)}>x</Cancel>}
          </Header>
          ...
          <TextArea type="text" value={question} name="question" onChange={this.handleChange} placeholder="Question" required />
          <DescriptionLine>
            <Description>Answer </Description>
          </DescriptionLine>
          <TextArea type="text" value={answer} name="answer" onChange={this.handleChange} placeholder="Answer" required />
        </CardInfo>
      </Container>
    );
  }
